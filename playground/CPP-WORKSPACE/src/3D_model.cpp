...
int main()
{
    ...
    // ------------------------------------
    Shader ourShader("./shaders/vertex/3D.vs", "./shaders/fragment/texture.fs"); // you can name your shader files however you like
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        int viewLoc = glGetUniformLocation(ourShader.ID, "viewx");
        ...
        int modelLoc2 = glGetUniformLocation(ourShader.ID, "model");
        glUniformMatrix4fv(modelLoc2, 1, GL_FALSE, glm::value_ptr(model));

        int viewLoc2 = glGetUniformLocation(ourShader.ID, "view");
        glUniformMatrix4fv(viewLoc2, 1, GL_FALSE, glm::value_ptr(view));

        int projectionLoc2 = glGetUniformLocation(ourShader.ID, "projection");
